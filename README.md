...
A PettingZoo multi agent environment for manned unmanned teaming with enforced safety gates, rules of engagement, engagement authorization, and AI decision logs that record every call the system made and why. Scripted autonomy flies the aircraft today and the reinforcement learning run is shelved. Private repo, case study in the portfolio. Deep RL foundations completed (Stanford XCS224R).
...
| INTENT Operator Console | Prototype | Private | One human, several unmanned wingmen, time pressure. Manned unmanned teaming C2 console over a PettingZoo multi agent testbed: tasking, engagement authorization, and AI decision logs that record every call the system made and why. Three scenarios, a five ship element, 261 tests, scripted autonomy. |
